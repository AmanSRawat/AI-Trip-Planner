...
export default function Signin({ onSendOtp,  onGoogleSignin  }) {
    ...
    <div className=" border-teal-400 border-2  rounded-2xl flex justify-center h-max">
      ...
      >
        ...
        <section className="flex flex-col justify-center gap-3 p-0 m-0">
          <button
            type="submit"
            className=" font-[Roboto] p-1 cursor-pointer bg-blue-400 border-4  border-blue-950 text-xl font-bold rounded-xl text-black"
          >
            Signin
          </button>
          <button
